...
def write_csv(path, new_data):
    path_log = "C:\BI_DATA\Data_ASM2\log.txt"
...
if __name__ == '__main__':
    ...
    # Path of files
    path_revenue = "C:\BI_DATA\Data_ASM2\hackgame_info.csv"
    path_quantity = "C:\BI_DATA\Data_ASM2\hackgame_contry.csv"
    path_new = "C:\BI_DATA\Data_ASM2\hackgame_new.csv"
    bc = Bcolors()
    ...
    while True:
        ...
        if choice == 1:
            while True:
                ...
                print("+ Choice: "
                      "\n\t\t1. Display: " + bc.OKCYAN + " Show country, player Banned reason" + bc.ENDC +
                      "\n\t\t2. Display: " + bc.OKCYAN + "Display player information" + bc.ENDC +
